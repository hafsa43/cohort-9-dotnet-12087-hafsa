...
const empty = { title: '', description: '', priority: 'Medium', status: 'Pending', dueDate: '', categoryId: '', assignedToUserId: '' };
      ...
      <div className="card" style={{ maxWidth: 640 }}>
        ...
        <form onSubmit={handleSubmit}>
          <div className="form-group">
            ...
            <input id="task-title" className="form-input" name="title" placeholder="Task title" value={form.title} onChange={handleChange} required />
          </div>

          <div className="form-group">
            <label className="form-label">Description</label>
            <textarea id="task-desc" className="form-textarea" name="description" placeholder="Describe the task..." value={form.description} onChange={handleChange} />
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
            <div className="form-group">
              ...
              <input id="task-due" className="form-input" type="date" name="dueDate" value={form.dueDate} onChange={handleChange} />
            </div>
            <div className="form-group">
              <label className="form-label">Category ID</label>
              <input id="task-category" className="form-input" type="number" name="categoryId" placeholder="1=General, 2=Work..." value={form.categoryId} onChange={handleChange} />
            </div>
          </div>
